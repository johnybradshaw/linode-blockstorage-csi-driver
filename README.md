...
parameters:
  ...
  csi.storage.k8s.io/node-stage-secret-namespace: csi-example-pvcluks
  csi.storage.k8s.io/node-stage-secret-name: csi-encypt-example-luks-key
---
apiVersion: v1
kind: Secret
metadata:
  name: csi-encypt-example-luks-key
  namespace: default
stringData:
